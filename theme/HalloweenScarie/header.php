...
<body>
	<div id="sidebar">
		<nav id="navigation-prim" class="small-screen">
			<?php eval($core->callHook('sidebar')); ?>
			<ul id="navigation-prim" class="connect-contents">
			...
			<div id="header_content">
				<div id="top-header">
					...
					<div id="site-name-container">
						...
						<a id="site-name" href="<?php show::siteUrl(); ?>"><?php show::siteName(); ?></a>
				...
				<div id="sub-header">
					<div id="sub-header-content">
						...
						<!-- Début de votre barre de navigation annexe -->
						<?php include ('nav-master.php'); ?>	
						<!-- fin de votre contenu -->						
					</div>
			...
			<div id="global">		
				...
				<aside id="menu-left" class="toggle-left">
					...
					<div class="module-mini-container">
						<div class="module-mini-top"><div class="sub_title">Un peu d'aide ?</div></div>
					...
					<!-- left-bloc 2 -->
					<div class="module-mini-container">
						<div class="module-mini-top"><div class="sub_title">Titre de menu</div></div>
							<div class="module-mini-contents">
								<!-- Début de votre contenu -->
								<br /><a title="mon titre" href="page.php">- Un lien</a>
								<br /><a title="mon titre" href="page.php">- Un lien</a>
				...
				<aside id="menu-right" class="toggle-right">
					...
					<div class="module-mini-container">
						<div class="module-mini-top"><div class="sub_title">Titre de menu</div></div>
							<div class="module-mini-contents">
								<!-- Début de votre contenu -->
								<br> Un Petit café ? ou pas!
								<hr>
								<br /><a title="mon titre" target="_blank" href="page.php">- Vacances au chaud!</a>
