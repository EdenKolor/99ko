...
<head>
	...
	<link href="theme/<?php show::theme("[id]"); ?>/css/cssplay.css" type="text/css" rel="stylesheet" />
	
	<script src="theme/<?php show::theme("[id]"); ?>/js/cssplay-menu-header.js"></script>
					...
					<div class="module-mini-container">
						<div class="module-mini-top"><h5 class="sub_title">Titre de menu</h5></div>
							<div class="module-mini-contents">
								...
								<br />Résolutions
								<br />------------------------
								<br />- Faire un joli site
								<br />- Demander si un soucis
								<!-- fin de votre contenu -->
							</div>
						<div class="module-mini-bottom"></div>
					</div>	
